    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                .authorizeHttpRequests(auth -> auth
                	.requestMatchers("/", "/authenticate", "/create-user").permitAll()
...
//                })
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user = User.withUsername("adhikrit")
                .passwordEncoder(password -> passwordEncoder().encode(password)) // Apply encoder function here
                .password("dummy") // Raw password to be encoded
                .authorities("read")
                .roles("USER")
                .build();
